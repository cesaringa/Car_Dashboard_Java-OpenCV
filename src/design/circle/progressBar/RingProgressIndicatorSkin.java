 ...
 */ 
package design.circle.progressBar;
...
public class RingProgressIndicatorSkin implements Skin<RingProgressIndicator> {
    ...
    private final RotateTransition transition = new RotateTransition(Duration.millis(1000), fillerArc);
    ...
    private void setProgressLabel(int value) {
        if (value >= 0) {
            ...
            percentLabel.setStyle("-fx-font-size: 40px; -fx-text-fill: blue; -fx-text-align: center");
        }
    }
